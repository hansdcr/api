...
class Browser(Protocol):
    """浏览器服务扩展，涵盖： 访问页面、URL跳转、输入框数据填充、移动鼠标、滚动页面、截图、执行js脚本等"""
    ...
    async def click(self,
                    index:Optional[int] = None, #页面元素索引
                    coordinate_x: Optional[float] = None, #页面元素的x坐标
                    coordinate_y: Optional[float] = None, #页面元素的y坐标
                    ) -> ToolResult:
